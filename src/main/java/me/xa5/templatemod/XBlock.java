...
public abstract class XBlock extends Block implements Registrable {
    ...
    public void registerItemBlock() {
        BlockItem blockItem = new BlockItem(this, new Item.Settings().itemGroup(TMInit.getInstance().getModGroup()));
        blockItem.registerBlockItemMap(Item.BLOCK_ITEM_MAP, blockItem);
        Registry.register(Registry.ITEM, TMInit.newIdentifier(getRegistryName()), blockItem);
    }
